...
public class FramePresupuestos extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        Agregar.setText("Agregar Presupuesto");
        ...
        Eliminar.setText("Eliminar Presupuesto");
        ...
        Editar.setText("Editar Presupuesto");
        ...
        jLabel2.setText("Gestión Presupuestos");
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        AddPresupuesto p1 = new AddPresupuesto();
        ShowPanel(p1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FramePresupuestos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FramePresupuestos().setVisible(true);
            }
        });
    }
