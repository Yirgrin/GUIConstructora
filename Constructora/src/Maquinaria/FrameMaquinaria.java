...
public class FrameMaquinaria extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        Agregar.setText("Agregar Máquina");
        ...
        Eliminar.setText("Eliminar Máquina");
        ...
        jLabel2.setText("Gestión Maquinaria");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(content, javax.swing.GroupLayout.DEFAULT_SIZE, 791, Short.MAX_VALUE))
        );
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        AddMaquinaria p1= new AddMaquinaria();
        ShowPanel(p1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameMaquinaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameMaquinaria().setVisible(true);
            }
        });
    }
